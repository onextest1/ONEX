...
<style id="onex-hexa-mobile-performance">
/* Hexa preview mobile pass: visual language stays intact, GPU-heavy layers do not. */
@media (max-width: 800px) {
  #page-dash #onexDashScene { display:none !important; }
  #page-dash .glass, #page-dash .onex-card, #page-dash .telegram-card {
    backdrop-filter:none !important; -webkit-backdrop-filter:none !important;
  }
  #page-dash .dock button:hover, #page-dash .quickitem:hover { transform:none !important; }
}
@media (prefers-reduced-motion: reduce) {
  #page-dash #onexDashScene { display:none !important; }
  #page-dash *, #page-dash *::before, #page-dash *::after { animation-duration:.01ms !important; transition-duration:.01ms !important; }
}
</style>
</head>
<body>
